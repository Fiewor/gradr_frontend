...
import ULStyles from './index.styled';
    ...
    <DashboardLayout>
      ...
      <main className=" bg-[#f9f9f9] flex flex-col gap-[35px] h-[100vh] p-[35px]">
        ...
        {/* <TableContainer overflowX="auto"
          ...
          <Table variant="unstyled" size='md' className="w-full">
            <Thead className="h-[58.26px]">
              <Tr className="text-[#A6A9AA] text-[13.82px] font-medium w-full">
            ...
            <Tbody>
              <Tr  className="h-[58.26px] text-[13.82px] font-medium w-full">
                <Td>inches</Td>
